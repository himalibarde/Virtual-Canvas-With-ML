...
def listen_for_command():
    ...
    try:
        ...
        if "screenshot" in command:
            take_screenshot("D:\\sem 6\\Virtual-Canvas-OpenCV\\screenshots")  # Replace with your desired file path
    except sr.UnknownValueError:
        print("Oops! Unable to understand speech.")
    except sr.RequestError as e:
        print("Oops! Could not request results from the speech recognition service:", str(e))

# Specify the desired location
directory_path = 'D:\sem 6\Virtual-Canvas-OpenCV'
# Call the function to navigate to the specified location
navigate_to_location(directory_path)
...
#Created two threads one for each loop
